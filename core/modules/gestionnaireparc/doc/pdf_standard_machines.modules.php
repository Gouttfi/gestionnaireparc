...
/**
 *  \file       core/modules/gestionnaireparc/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_machines
 */
class pdf_standard_machines extends ModelePDFMachines
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_MACHINES_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->gestionnaireparc->dir_output.'/machines') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->gestionnaireparc->dir_output.'/machines';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->gestionnaireparc->dir_output.'/machines/'.$objectref;
