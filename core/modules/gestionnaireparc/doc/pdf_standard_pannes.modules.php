...
/**
 *	Class to manage PDF template standard_pannes
 */
class pdf_standard_pannes extends ModelePDFPannes
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_PANNES_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->gestionnaireparc->dir_output.'/pannes') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->gestionnaireparc->dir_output.'/pannes';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->gestionnaireparc->dir_output.'/pannes/'.$objectref;
