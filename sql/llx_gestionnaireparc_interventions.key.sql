...
--ALTER TABLE llx_gestionnaireparc_interventions ADD CONSTRAINT llx_gestionnaireparc_interventions_fk_field FOREIGN KEY (fk_field) REFERENCES llx_gestionnaireparc_myotherobject(rowid);
