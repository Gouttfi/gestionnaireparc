...
/**
 * \file    test/phpunit/GestionnaireParcFunctionalTest.php
...
/**
 * Class GestionnaireParcFunctionalTest
 *
 ...
 *
 * @package Testgestionnaireparc
 */
class GestionnaireParcFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modGestionnaireParc')->click();
		} else {
			// Disable the module
			$this->byHref('modGestionnaireParc')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/gestionnaireparc/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('gestionnaireparc/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/gestionnaireparc/admin/about.php');
		$this->authenticate();
		return $this->assertContains('gestionnaireparc/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('gestionnaireparcwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGestionnaireParc_GestionnaireParcTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGestionnaireParc_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
